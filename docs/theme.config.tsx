...
const config: DocsThemeConfig = {
  project: {
    link: 'https://github.com/JHSeo-git/fastify-esm-for-starter',
  },
  docsRepositoryBase: 'https://github.com/JHSeo-git/fastify-esm-for-starter/tree/main/docs',
  editLink: {
  ...
  useNextSeoProps() {
    ...
    return {
      ...
      additionalMetaTags: [
        ...
        { content: 'Fastify Starter', name: 'apple-mobile-web-app-title' },
      ],
      description: frontMatter.description || 'Repository using Fasitfy ESM for starter',
      openGraph: {
        images: [
          {
            url: frontMatter.image || '/og.png',
          },
        ],
      },
      titleTemplate: asPath === '/' ? '%s' : '%s - Docs',
      twitter: {
        cardType: 'summary_large_image',
        site: 'https://fastify-starter.vercel.app',
      },
    };
  },
  logo,
  ...
  footer: {
    text: (
      <div className="flex w-full flex-col items-center sm:items-start">
        ...
        <p className="mt-6 text-xs">© {new Date().getFullYear()} Fastify ESM for starter.</p>
      </div>
    ),
  },
};
